...
class PredictiveModel:
    ...
    def optimize_cluster_parameters(self, cluster_df, parametri_variabili, target, objective='min',
        ...
        punto_ottimizzato = base_point.copy()
        ...
        result = {
            ...
            'complete_point': punto_ottimizzato,
    ...
    def pipeline(self, ottimizza=True, visualizza_feature_importance=True, 
        ...
        Args:
            ottimizza: If optimize hyperparameters
            visualizza_feature_importance: If visualize feature importance
            salva_modello: If save the best model
        ...
        if compare_scenarios:
            df_confronto_scenari = self.compare_scenarios(
            cluster_df=cluster_df, 
            scenarios=scenarios,
            target=target, 
            modello=best_model
        ...
        return self.best_model, self.best_score, files_salvati, df_prediction, results_sensitivity_analysis, df_confronto_scenari
...
def run_model(
    ...
    return predictions_df,results_analisi_sensibilita,df_confronto_scenari
